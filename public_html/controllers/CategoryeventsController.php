...
class CategoryeventsController extends Controller
{
    ...
    /**
     * Lists all Categoryevents models.
     * @return mixed
     */
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Categoryevents::find(),
        ]);
    ...
    /**
     * Displays a single Categoryevents model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Categoryevents model.
    ...
    /**
     * Updates an existing Categoryevents model.
